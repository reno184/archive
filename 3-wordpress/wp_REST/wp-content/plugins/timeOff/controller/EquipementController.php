...
class EquipementController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        if (self::$instance == null) {
            self::$instance = new EquipementController();
        }
        self::$instance->equipement = new Equipement($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->equipement->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->equipement->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->equipement->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->equipement->delete((int) $request->get_param("id")) === false) {
    ...
    public function get_items_permissions_check($request) {
        return Permission::allowRead("Equipement");
    }
    ...
    public function create_item_permissions_check($request) {
        ...
        return Permission::allowWrite("Equipement");
    }
    ...
    public function delete_item_permissions_check($request) {
        ...
        return Permission::allowDelete("Equipement");
    }
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validateEquipement($obj, $update);
    }
