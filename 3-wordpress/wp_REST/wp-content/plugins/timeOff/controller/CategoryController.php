...
class CategoryController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        self::$instance->category = new Category($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->category->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->category->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->category->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->category->delete((int) $request->get_param("id")) === false) {
    ...
    public function get_items_permissions_check($request) {
        ...
        return Permission::allowRead("Category");
    }
    ...
    public function create_item_permissions_check($request) {
        ...
        return Permission::allowWrite("Category");
    }
    ...
    public function delete_item_permissions_check($request) {
        ...
        return Permission::allowDelete("Category");
    }
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validateCategory($obj, $update);
    }
