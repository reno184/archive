...
class StaffController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        self::$instance->staff = new Staff($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->staff->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->staff->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->staff->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->staff->delete((int) $request->get_param("id")) === false) {
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validateStaff($obj, $update);
    }
