...
class CompanyController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        self::$instance->company = new Company($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->company->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->company->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->company->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->company->delete((int) $request->get_param("id")) === false) {
    ...
    public function get_items_permissions_check($request) {
        return Permission::allowRead("Company");
    }
    ...
    public function create_item_permissions_check($request) {
        return Permission::allowWrite("Company");
    }
    ...
    public function delete_item_permissions_check($request) {
        ...
        return Permission::allowDelete("Company");
    }
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validateStandard($obj, $update);
    }
