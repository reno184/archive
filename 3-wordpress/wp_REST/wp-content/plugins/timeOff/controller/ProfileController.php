...
class ProfileController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        self::$instance->profile = new Profile($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->profile->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->profile->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->profile->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->profile->delete((int) $request->get_param("id")) === false) {
    ...
    public function get_items_permissions_check($request) {
        return Permission::allowRead("Profile");
    }
    ...
    public function create_item_permissions_check($request) {
        return Permission::allowWrite("Profile");
    }
    ...
    public function delete_item_permissions_check($request) {
        return Permission::allowDelete("Profile");
    }
