...
class IndispoController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        if (self::$instance == null) {
            self::$instance = new IndispoController();
        }
        self::$instance->indispo = new Indispo($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->indispo->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->indispo->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->indispo->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->indispo->delete((int) $request->get_param("id")) === false) {
    ...
    public function get_items_permissions_check($request) {
        return Permission::allowRead("Indispo");
    }
    ...
    public function create_item_permissions_check($request) {
        return Permission::allowWrite("Indispo");
    }
    ...
    public function delete_item_permissions_check($request) {
        return Permission::allowDelete("Indispo");
    }
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validateIndispo($obj, $update);
    }
