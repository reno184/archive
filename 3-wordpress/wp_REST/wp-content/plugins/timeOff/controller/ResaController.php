...
class ResaController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        if (self::$instance == null) {
            self::$instance = new ResaController();
        }
        self::$instance->resa = new Resa($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->resa->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->resa->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->resa->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->resa->delete((int) $request->get_param("id")) === false) {
    ...
    public function get_items_permissions_check($request) {
        return Permission::allowRead("Resa");
    }
    ...
    public function create_item_permissions_check($request) {
        return Permission::allowWrite("Resa");
    }
    ...
    public function delete_item_permissions_check($request) {
        return Permission::allowDelete("Resa");
    }
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validateResa($obj, $update);
    }
