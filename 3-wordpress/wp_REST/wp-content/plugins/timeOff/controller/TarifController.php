...
class TarifController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        if (self::$instance == null) {
            self::$instance = new TarifController();
        }
        self::$instance->tarif = new Tarif($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->tarif->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->tarif->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->tarif->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->tarif->delete((int) $request->get_param("id")) === false) {
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validateTarif($obj, $update);
    }
