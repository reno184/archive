...
class PaiementController extends WP_REST_Controller {
    ...
    public static function init() {
        ...
        if (self::$instance == null) {
            self::$instance = new PaiementController();
        }
        self::$instance->paiement = new Paiement($wpdb);
    ...
    public function get_item(WP_REST_Request $request) {
        ...
        $item = $this->paiement->getItem($params["_id"]);
        if (is_array($item)) {
    ...
    public function create_item($request) {
        ...
        $response = $this->paiement->create($content);
    ...
    public function update_item($request) {
        ...
        $response = $this->paiement->update($content);
        return new WP_REST_Response($response, 200);
    }
    ...
    public function delete_item($request) {
        ...
        if ($this->paiement->delete((int) $request->get_param("id")) === false) {
    ...
    public function get_items_permissions_check($request) {
        return Permission::allowRead("Paiement");
    }
    ...
    public function create_item_permissions_check($request) {
        return Permission::allowWrite("Paiement");
    }
    ...
    public function delete_item_permissions_check($request) {
        return Permission::allowDelete("Paiement");
    }
    ...
    protected function prepare_body_for_database($request, $update = false) {
        ...
        return Validation::validatePaiement($obj, $update);
    }
